...
import (
	...
	"github.com/kripsy/gophermarttest/internal/fork"
)
...
func (suite *Iteration14Suite) serverShutdown() {
...
func (suite *Iteration14Suite) agentShutdown() {
...
func (suite *Iteration14Suite) TestCounterGzipHandlers() {
...
func (suite *Iteration14Suite) TestGaugeGzipHandlers() {
...
func (suite *Iteration14Suite) TestCollectAgentMetrics() {
	httpc := resty.New().SetHostURL(suite.serverAddress)
