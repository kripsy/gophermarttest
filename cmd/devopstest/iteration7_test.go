...
func (suite *Iteration7Suite) serverUp(ctx context.Context, envs, args []string, port string) {
...
func (suite *Iteration7Suite) agentUp(ctx context.Context, envs, args []string, port string) {
